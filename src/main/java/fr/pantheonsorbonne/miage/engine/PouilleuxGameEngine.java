...
public abstract class PouilleuxGameEngine {
    ...
    public void play() {
        ...
        for (String player : players) {
            ...
            for (Integer rankRemoved : pairs.keySet()) {
                if (rankRemoved != null && (rankRemoved == 10 || rankRemoved == 11 || rankRemoved == 12
                        || rankRemoved == 13 || rankRemoved == 14)) {
    ...
    protected String playRound(Deque<String> players, String firstPlayerInRound, String secondPlayerInRound,
            Map<Integer, List<Integer>> tourColor) {
        ...
        System.out.println("\n" + firstPlayerInRound + " took " + cardToFirstPlayer.toFancyString() + " from "
                + secondPlayerInRound);
