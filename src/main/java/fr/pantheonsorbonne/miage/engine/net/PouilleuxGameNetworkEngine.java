...
public class PouilleuxGameNetworkEngine extends PouilleuxGameEngine {
    ...
    public PouilleuxGameNetworkEngine(Deck deck, HostFacade hostFacade, Set<String> players, fr.pantheonsorbonne.miage.model.Game pouilleux) {
        super(deck);
    ...
    public static void main(String[] args) {
        ...
        PouilleuxGameEngine host = new PouilleuxGameNetworkEngine(new RandomDeck(), hostFacade, pouilleux.getPlayers(), pouilleux);
        host.play();
        System.exit(0);
    }
//
...
//
    ...
    protected void giveCardsToPlayer(Collection<Card> roundStack, String player) {
        ...
        hostFacade.sendGameCommandToPlayer(pouilleux, player, new GameCommand("cardsForYou", Card.cardsToString(cards.toArray(new Card[cards.size()]))));
    }
    ...
    protected int removePairsFromPlayer(String player, List<Integer> tourColor){
        ...
        if (pairs != null && pairs.size() == 2) {
            ...
            if (expectedHand.name().equals("cards")) {
                ...
                hostFacade.sendGameCommandToPlayer(pouilleux, player, new GameCommand("clearHand"));
